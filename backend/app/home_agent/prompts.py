...
- Examples:
  - "사기죄 공소시효 알려줘" → simple
  - "내 사건 목록 보여줘" → simple
  - "강수연 사건 주요 쟁점 요약해줘" → simple
  - "박대리 사건 주요 쟁점 분석해줘" → simple
...
**⚠️ 법률 답변 시 도구 결과의 판례번호/법조문을 반드시 본문에서 인용하세요!**

**잘못된 예:**
- ❌ "공소시효는 10년입니다." (출처 없이 주장 - 금지!)
- ❌ "출처: 대법원 93도1384에서 ~라고 판시하였습니다" (출처 라인에 설명 넣기 - 금지!)

**올바른 예:**
- ✅ 본문에서: "**대법원 93도1384** 판결에 따르면 운전자는 피해자의 상해 여부를 확인하고 구호조치를 취해야 합니다."
- ✅ 본문에서: "**도로교통법 제54조**에 의하면 사고 발생 시 즉시 정차해야 합니다."

**형식 (반드시 준수):**
1. **본문**: 판례/법조문을 인용하면서 내용 설명 (여기서 판시 내용 언급!)
2. **답변 끝**: `**출처:** 대법원 93도1384, 도로교통법 제54조` (번호만 나열, 설명 X)
